...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_2.addLayout(self.lay_h_con_fls)
        self.tab_src = QtWidgets.QTabWidget(self.frame_4)
        ...
        self.lbl_img_capt = QtWidgets.QLabel(self.tab_img_preview)
        self.lbl_img_capt.setMinimumSize(QtCore.QSize(110, 25))
        self.lbl_img_capt.setMaximumSize(QtCore.QSize(100, 25))
        self.lbl_img_capt.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lbl_img_capt.setObjectName("lbl_img_capt")
        self.horizontalLayout_11.addWidget(self.lbl_img_capt)
        self.tbx_img_capt = QtWidgets.QLineEdit(self.tab_img_preview)
        self.tbx_img_capt.setEnabled(False)
        self.tbx_img_capt.setMinimumSize(QtCore.QSize(0, 0))
        self.tbx_img_capt.setMaximumSize(QtCore.QSize(16777215, 25))
        self.tbx_img_capt.setObjectName("tbx_img_capt")
        self.horizontalLayout_11.addWidget(self.tbx_img_capt)
        self.verticalLayout_6.addLayout(self.horizontalLayout_11)
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_8.setContentsMargins(-1, 0, -1, -1)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.lbl_img_stts = QtWidgets.QLabel(self.tab_img_preview)
        self.lbl_img_stts.setMinimumSize(QtCore.QSize(110, 0))
        self.lbl_img_stts.setMaximumSize(QtCore.QSize(100, 25))
        self.lbl_img_stts.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lbl_img_stts.setObjectName("lbl_img_stts")
        self.horizontalLayout_8.addWidget(self.lbl_img_stts)
        self.tbx_img_stts = QtWidgets.QLineEdit(self.tab_img_preview)
        self.tbx_img_stts.setEnabled(False)
        self.tbx_img_stts.setObjectName("tbx_img_stts")
        self.horizontalLayout_8.addWidget(self.tbx_img_stts)
        self.verticalLayout_6.addLayout(self.horizontalLayout_8)
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setContentsMargins(-1, 0, -1, -1)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.lbl_img_eope = QtWidgets.QLabel(self.tab_img_preview)
        self.lbl_img_eope.setMinimumSize(QtCore.QSize(110, 25))
        self.lbl_img_eope.setMaximumSize(QtCore.QSize(100, 25))
        self.lbl_img_eope.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lbl_img_eope.setObjectName("lbl_img_eope")
        self.horizontalLayout_7.addWidget(self.lbl_img_eope)
        self.tbx_img_eope = QtWidgets.QLineEdit(self.tab_img_preview)
        self.tbx_img_eope.setEnabled(False)
        self.tbx_img_eope.setObjectName("tbx_img_eope")
        self.horizontalLayout_7.addWidget(self.tbx_img_eope)
        self.verticalLayout_6.addLayout(self.horizontalLayout_7)
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_10.setContentsMargins(0, 0, -1, -1)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.cbx_img_pub = QtWidgets.QCheckBox(self.tab_img_preview)
        self.cbx_img_pub.setEnabled(True)
        self.cbx_img_pub.setMaximumSize(QtCore.QSize(16777215, 25))
        self.cbx_img_pub.setObjectName("cbx_img_pub")
        self.horizontalLayout_10.addWidget(self.cbx_img_pub)
        self.cbx_img_edit = QtWidgets.QCheckBox(self.tab_img_preview)
        self.cbx_img_edit.setEnabled(True)
        self.cbx_img_edit.setMaximumSize(QtCore.QSize(16777215, 25))
        self.cbx_img_edit.setObjectName("cbx_img_edit")
        self.horizontalLayout_10.addWidget(self.cbx_img_edit)
        ...
        self.verticalLayout_6.addWidget(self.btn_open_gimp)
        ...
        self.horizontalLayout_9.addWidget(self.tab_img_info)
        ...
        self.horizontalLayout_2.addWidget(self.tab_src)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_img_capt.setText(_translate("MainWindow", "キャプション : "))
        self.lbl_img_stts.setText(_translate("MainWindow", "ステータス : "))
        self.lbl_img_eope.setText(_translate("MainWindow", "追加処理 : "))
        self.cbx_img_pub.setText(_translate("MainWindow", "公開設定"))
        self.cbx_img_edit.setText(_translate("MainWindow", "削除可能"))
