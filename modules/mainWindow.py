...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab_mat_src = QtWidgets.QTabWidget(self.tab_mat)
        self.tab_mat_src.setIconSize(QtCore.QSize(24, 24))
        self.tab_mat_src.setObjectName("tab_mat_src")
        self.tab_mat_src_img = QtWidgets.QWidget()
        self.tab_mat_src_img.setObjectName("tab_mat_src_img")
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout(self.tab_mat_src_img)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.lst_mat_fls = QtWidgets.QListWidget(self.tab_mat_src_img)
        self.lst_mat_fls.setObjectName("lst_mat_fls")
        self.horizontalLayout_9.addWidget(self.lst_mat_fls)
        self.tab_img_info = QtWidgets.QTabWidget(self.tab_mat_src_img)
        ...
        self.btn_mat_img_sav = QtWidgets.QPushButton(self.frame)
        self.btn_mat_img_sav.setText("")
        self.btn_mat_img_sav.setObjectName("btn_mat_img_sav")
        self.horizontalLayout_6.addWidget(self.btn_mat_img_sav)
        ...
        self.tab_mat_src.addTab(self.tab_mat_src_img, "")
        self.tab_mat_src_snd = QtWidgets.QWidget()
        self.tab_mat_src_snd.setObjectName("tab_mat_src_snd")
        self.tab_mat_src.addTab(self.tab_mat_src_snd, "")
        self.horizontalLayout_2.addWidget(self.tab_mat_src)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tab_mat_src.setTabText(self.tab_mat_src.indexOf(self.tab_mat_src_img), _translate("MainWindow", "画像"))
        self.tab_mat_src.setTabText(self.tab_mat_src.indexOf(self.tab_mat_src_snd), _translate("MainWindow", "音声"))
