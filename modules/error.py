...
class ErrorMessageFileLocked(ErrorMessage):
    def __init__(self, details=None, show=True, language="en"):
        ...
        if self._language == "ja":
            ...
            self._information = "このファイルはロックされています。削除するためには、ロックを解除する必要があります。オリジナルのファイルは削除できません。"
        elif self._language == "en":
            self._message = "This file is locked."
            self._information = "To delete file, the file lock should be released. Original file cannot delete permanently"
