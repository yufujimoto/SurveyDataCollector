...
# Form implementation generated from reading ui file '/home/yufujimoto/Desktop/QtApp/Source/mainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tre_con_fl = QtWidgets.QTreeWidget(self.tab_con)
        self.tre_con_fl.setObjectName("tre_con_fl")
        self.tre_con_fl.header().setDefaultSectionSize(100)
        self.lay_h_con_fls.addWidget(self.tre_con_fl)
        ...
        self.tre_mat_fl = QtWidgets.QTreeWidget(self.tab_mat)
        self.tre_mat_fl.setObjectName("tre_mat_fl")
        self.tre_mat_fl.header().setDefaultSectionSize(100)
        self.horizontalLayout_2.addWidget(self.tre_mat_fl)
        ...
        self.bar_menu.setGeometry(QtCore.QRect(0, 0, 1027, 31))
